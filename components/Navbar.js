                ...
                <div className="container px-6 py-2 mx-auto md:flex">
                    ...
                    <div className="w-full md:flex md:items-center md:justify-between">
                        ...
                        <div className="relative flex">
                            ...
                            <input
                                type="text"
                                className="w-full mr-4  py-2 pl-10 pr-4 text-gray-700 bg-white dark:bg-ytd-800 rounded-md  dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                                placeholder="Search"
                            />
