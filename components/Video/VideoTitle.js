...
const VideoTitle = ({ data }) => {
    ...
    return (
        <div>
            ...
            "
                >
                    <a className="text-gray-500 dark:text-true-gray-200">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-5 w-5"
                            viewBox="0 0 24 24"
                    ...
                    <a className="ml-2 text-gray-500 dark:text-true-gray-200">
                        {data.video.like_count.toLocaleString()}
                    </a>
                    {data.video.dislike_count > 0 && (
                        <>
                            <a className="ml-3 text-gray-500 dark:text-true-gray-200">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"
                    ...
                    <a
                        className="ml-3 text-gray-500 dark:text-true-gray-200"
